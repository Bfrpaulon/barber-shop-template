...
import { Container, Grid, Typography, TextField, Button, Link, Alert, Box, Fade } from '@mui/material';
...
const Footer = () => {
    ...
    return (
        <Fade in={isVisible} timeout={1000}>
            <Container
                ref={sectionRef}
                maxWidth="xl" sx={{ background: 'var(--bg-100)', padding: '2rem 0', justifyContent: 'center' }}>
